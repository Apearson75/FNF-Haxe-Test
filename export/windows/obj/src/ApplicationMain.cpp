...
HXLINE(  18)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("BF Test",4e,64,29,5a),::ApplicationMain_obj::create_dyn());
...
HXLINE(  35)		app->meta->set(HX_("build",2e,db,ea,ba),HX_("99",e0,31,00,00));
HXLINE(  36)		app->meta->set(HX_("company",3d,15,69,83),HX_("HaxeFlixel",42,8f,0c,ac));
HXLINE(  37)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("BF Test",4e,64,29,5a));
HXLINE(  38)		app->meta->set(HX_("name",4b,72,ff,48),HX_("BF Test",4e,64,29,5a));
HXLINE(  39)		app->meta->set(HX_("packageName",f1,04,ad,04),HX_("com.phoneguy.flixeltest",f2,28,60,6f));
HXLINE(  40)		app->meta->set(HX_("version",18,e7,f1,7c),HX_("0.6",78,94,24,00));
HXLINE(  46)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("BF Test",4e,64,29,5a))
