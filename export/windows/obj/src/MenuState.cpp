...
HX_LOCAL_STACK_FRAME(_hx_pos_1f119275e66a7b90_13_clickPlay,"MenuState","clickPlay",0x5f6a9ec0,"MenuState.clickPlay","MenuState.hx",13,0xdfbcb22c)
...
void MenuState_obj::clickPlay(){
            	HX_GC_STACKFRAME(&_hx_pos_1f119275e66a7b90_13_clickPlay)
HXDLIN(  13)		 ::flixel::FlxState nextState =  ::PlayState_obj::__alloc( HX_CTX ,null());
HXDLIN(  13)		if (::flixel::FlxG_obj::game->_state->switchTo(nextState)) {
HXDLIN(  13)			::flixel::FlxG_obj::game->_requestedState = nextState;
            		}
            	}
...
HXLINE(  18)		this->playButton =  ::flixel::ui::FlxButton_obj::__alloc( HX_CTX ,0,0,HX_("Play",14,5a,33,35),this->clickPlay_dyn());
HXLINE(  19)		this->add(this->playButton);
HXLINE(  20)		this->playButton->screenCenter(null());
HXLINE(  21)		this->super::create();
            	}


void MenuState_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_1f119275e66a7b90_26_update)
